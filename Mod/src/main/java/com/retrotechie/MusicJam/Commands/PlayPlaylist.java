...
//		Command playPlaylist = new Command("playlist", "Changes the volume of the audio being played", (args) -> {
//		
//		});
		//registry.register(volume);
	}

	   //For the args below, remember to switch args[1] to args[0] because the parameters array position is adjusted during the command process. 
